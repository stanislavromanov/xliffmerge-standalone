...
import {ITranslationMessagesFile, ITransUnit,
    ...
    NORMALIZATION_FORMAT_DEFAULT, STATE_FINAL, STATE_TRANSLATED} from '../lib/index';
...
export class XliffMerge {
     ...
     * @deprecated Use the new CLI with Commander.js instead
     */
    ...
    private areSourceReferencesEqual(
        ...
        // both refs are set now, convert to set to compare them
